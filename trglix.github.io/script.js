...
const usuarios = [
    { username: 'ruben.saipol@trglix.inc', password: '12081986ru', redirectUrl: 'pagina-ruben.html' },
    { username: 'pablo.sanbal@trglix.inc', password: 'PABLITO2011', redirectUrl: 'pagina-pablo.html' },
    { username: 'usuario3@trglix.inc', password: '12081986ru', redirectUrl: 'pagina-admin.html' },
    { username: 'usuario4@trglix.inc', password: 'password4', redirectUrl: 'admin.page' },
    { username: 'usuario5@trglix.inc', password: 'password5', redirectUrl: 'pagina-usuario5.html' }
];
